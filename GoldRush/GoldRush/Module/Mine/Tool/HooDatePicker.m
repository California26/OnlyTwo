...
//天数
static CGFloat const kHooDatePickerScrollViewDaysWidth = 45.0f;
//月数
static CGFloat const kHooDatePickerScrollViewMonthWidth = 70.0f;
//日期
static CGFloat const kHooDatePickerScrollViewDateWidth = 82.0f;
...
// Constants fonts
#define kHooDatePickerTitleFont [UIFont systemFontOfSize:13.0]
#define kHooDatePickerLabelFont [UIFont systemFontOfSize:13.0]
#define kHooDatePickerLabelSelectedFont [UIFont systemFontOfSize:15.0];

// Constants colors :
#define kHooDatePickerTintColor [UIColor colorWithRed:153.0/255.0 green:153.0/255.0 blue:153.0/255.0 alpha:1.0]
#define kHooDatePickerHighlightColor [UIColor colorWithRed:0.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:1.0]
...
- (instancetype)initWithSuperView:(UIView *)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(0.0, superView.frame.size.height, superView.frame.size.width * 0.5, kHooDatePickerHeight)]) {
...
- (instancetype)initDatePickerMode:(HooDatePickerMode)datePickerMode andAddToSuperView:(UIView *)superView {
    if (self = [super initWithFrame:CGRectMake(superView.frame.size.width * 0.5, superView.frame.size.height, superView.frame.size.width * 0.5, kHooDatePickerHeight)]) {
...
-(void)show {
    ...
    [UIView animateWithDuration:kHooDatePickerAnimationDuration delay:0.0 options: UIViewAnimationOptionCurveEaseOut animations:^{
...
//        self.transform = CGAffineTransformMakeTranslation(0, -kHooDatePickerHeight);
...
- (NSDate*)convertToDate:(NSInteger)days hours:(NSInteger)hours minutes:(NSInteger)minutes seconds:(NSInteger)seconds {
    ...
    NSMutableString *dateString = [[NSMutableString alloc] initWithString:[NSString stringWithFormat:@"%@",[date stringForFormat:@"dd-MM-yyyy"]]];
...
- (UIView *)headerView {
    if (!_headerView) {
        ...
        // Label Title
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(cancelButton.frame), 0.0, self.frame.size.width - ((kHooDatePickerButtonHeaderWidth + kHooDatePickerPadding) * 2 ), kHooDatePickerHeaderHeight)];
