...
@protocol GRNumberBtnDelegate <NSObject>
...
/** 代理*/
@property (nonatomic, weak) id<GRNumberBtnDelegate> delegate;
...
@interface NSString (GRNumberBtn)
/**
 字符串 nil, @"", @"  ", @"\n" Returns NO;
 其他 Returns YES.
 */
