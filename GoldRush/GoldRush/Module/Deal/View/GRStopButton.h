...
@protocol GRStopButtonDelegate <NSObject>
...
/** 代理*/
@property (nonatomic, weak) id<GRStopButtonDelegate> delegate;
...
@interface NSString (GRStopButton)
/**
 字符串 nil, @"", @"  ", @"\n" Returns NO;
 其他 Returns YES.
 */
