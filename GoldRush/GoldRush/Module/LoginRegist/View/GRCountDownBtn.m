...
- (void)touched:(GRCountDownBtn *)sender{
...
- (void)startWithSecond:(int)totalSecond{
    ...
    _timer = [NSTimer scheduledTimerWithTimeInterval:0.0 target:self selector:@selector(timerStart:) userInfo:nil repeats:YES];
...
- (void)timerStart:(NSTimer *)theTimer {
    ...
    _second = _totalSecond - (int)(deltaTime + 0.1) ;
