//
//  GRMineAttentionViewController.m
//  GoldRush
//
...
#import "GRMineAttentionViewController.h"
#import "GRMineDealRingFansCell.h"          ///粉丝cell
#import "GRMineDealRingFansModel.h"         ///粉丝模型

@interface GRMineAttentionViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation GRMineAttentionViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    WS(weakSelf)
    cell.fellowBlock = ^{
        UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:@"你确定要取消关注吗?" message:@"" preferredStyle:UIAlertControllerStyleActionSheet];
