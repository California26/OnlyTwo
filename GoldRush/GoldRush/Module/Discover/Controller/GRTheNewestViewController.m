...
#import "GRTheNewestViewController.h"
#import "GRDynamicStateCell.h"          //动态 cell
#import "GRDynamicStateCellFrame.h"     //frame 模型
#import "GRDynamicStateModel.h"         //数据模型

@interface GRTheNewestViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation GRTheNewestViewController
...
- (NSArray *)creatModelsWithCount:(NSInteger)count{
    NSArray *iconImageNamesArray = @[@"Balloon",
                                     @"Balloon",
                                     @"Balloon",
                                     @"Balloon",
                                     @"Balloon",
