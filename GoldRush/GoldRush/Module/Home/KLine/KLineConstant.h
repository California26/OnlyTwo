...
#ifndef KLineConstant_h
#define KLineConstant_h


#endif /* KLineConstant_h */

#define ChartKLineNeedMoreDataNotification @"chartKLineNeedMoreDataNotification"
...
/**
 宽度的不同，点击产品的宽度
 */
#define GetClickProductWidth(tag) \
({\
CGFloat width;\
if (tag == iPhone5)\
width = 125;\
...
#define Y_StockChartLongPressVerticalLabelWidth 130

#define Y_StockChartLongPressHorizontalLabelWidth 50
/**
 *  MA线的宽度
 */
